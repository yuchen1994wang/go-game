...
### 2024-05-25 (最新)
- 🔊 **音效系统完善**：重写 SoundManager，使用 Web Audio API 合成高质量音效（落子木头声、提子碰撞声、胜利和弦、失败下行音、过风声、悔棋音效），支持音量调节
- ✨ **落子动画优化**：优化棋子落下动画曲线（cubic-bezier(0.34, 1.56, 0.64, 1)），最后落子标记添加脉冲动画，更醒目
- ⏱️ **计时器**：本地对弈支持黑白双方独立正计时，无读秒规则
